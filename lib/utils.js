...
var SingapuRatePrefs = 
{
    ...
    readPrefs: function()
    {
	    //SingapuRateSS.storage will always be loaded automatically when chrome starts
	    var strKeyAuthenticate = SingapuRateUtilities.SingapuRatePrefKeyAuthenticate;
	    
	    /*
	    if(SingapuRateSS.storage[strKeyAuthenticate] === true
	    		|| SingapuRateSS.storage[strKeyAuthenticate] == "true" )
	    {
		    return;
	    }
	    //*/
...
/*
var SingapuRateBlockedPage 		= SingapuRateUtilities.SingapuRateLocalBlockedHtml; //chrome.extension.getURL(SingapuRateUtilities.SingapuRateLocalBlockedHtml);
var SingapuRateBlkDftPage 		= SingapuRateUtilities.SingapuRateLocalBlockedDefaultHtml; //chrome.extension.getURL(SingapuRateUtilities.SingapuRateLocalBlockedDefaultHtml);
var SingapuRateSuspendPage 		= SingapuRateUtilities.SingapuRateLocalSuspendedHtml; //chrome.extension.getURL(SingapuRateUtilities.SingapuRateLocalSuspendedHtml);
var SingapuRateSuperSafePage 	= SingapuRateUtilities.SingapuRateLocalSuperSafeHtml; //chrome.extension.getURL(SingapuRateUtilities.SingapuRateLocalSuperSafeHtml);
...
var SingapuRateWebsiteRatings = 
{
    ...
    isBlackList: function(aTab, weburl)
    {
		...
		try
		{	
		    if( SingapuRateSS.storage[SingapuRateUtilities.SingapuRatePrefKeyAuthenticate] == 'false' 
		    		|| SingapuRateSS.storage[SingapuRateUtilities.SingapuRatePrefKeyAuthenticate] === false)
		    {
