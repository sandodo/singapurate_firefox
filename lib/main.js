...
SingapuRatePanel.on("show", function() {
	...
	SingapuRatePanel.port.emit("c_username", SingapuRateSS.storage[SingapuRateUtils.SR_Utilities.SingapuRatePrefKeyAcctName]);
	SingapuRatePanel.port.emit("c_birthday", "15-08-2014");
	SingapuRatePanel.port.emit("authenticate", SingapuRateSS.storage[SingapuRateUtils.SR_Utilities.SingapuRatePrefKeyAuthenticate]);
	...
	SingapuRatePanel.port.emit("curDomainUrlIdx", "23");
	...
	SingapuRatePanel.port.emit("voteId", "12");
});
